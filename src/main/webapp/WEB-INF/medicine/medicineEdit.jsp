...
<form name="form1" action="editMedicine" enctype="multipart/form-data" method="post">
    ...
    <table class="table  table-bordered">
        ...
        <tr>
            ...
            <td><input type="text" name="author"  style="width:300px" value="${medicine.price}"/></td>
        </tr>
        <tr>
            <td style="color: #66afe9">生产商</td>
            <td><input type="text" name="price" style="width:300px"  value="${medicine.press}"/></td>
        </tr>
        <tr>
            <td style="color: #66afe9">药品国标（YB）</td>
            <td><input type="text" name="press"  style="width:300px" value="${medicine.YB}"/></td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3" align="center">
                ...
                <input type = "reset" value = "重置" onclick = "" style="color: #999999">
            </td>
        </tr>
    </table>
