    ...
    <c:forEach items="${medicine}" var="medicine" varStatus="s">
        <form name='form' action='showAllMedicine'>
            ...
            <tr>
                ...
                <td><a href='showOneMedicine?id=${medicine.id}'><img src="${basePath}/img/edit.png"></a><a href='delBook?id=${medicine.id}' onClick="return confirm('确定删除?');"><img src="${basePath}/img/delete.png"></a></td>
            </tr>
        </form>
    </c:forEach>
    </tbody>
